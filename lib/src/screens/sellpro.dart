...
class SellMotor extends StatefulWidget {
  @override
  _SellMotorState createState() => _SellMotorState();
}

class _SellMotorState extends State<SellMotor> {
  int cardItem = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('sellMotor').snapshots(),
                      ...
                      Flexible(
                        child: ListTile(
                          ...
                          subtitle: Row(
                            ...
                            children: [
                              Text(price.toString(),style: TextStyle(fontWeight: FontWeight.bold,color: Colors.lightBlueAccent)),
                              Text(currency,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.lightBlueAccent)),
                            ],
                          ),
                        ),
                      ),
